export default class Book {
    constructor(name, isGoodReadsAuthor, born, died, website, genres, memberSince, description, books, bookshelves = [], friends = [], currentlyReading = null, groups = [], favouriteAuthors = [], friendsComments = []) {
        this.name = name;
